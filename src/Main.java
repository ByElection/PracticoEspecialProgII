...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (jugador1.cantCartas()>0 && jugador2.cantCartas()>0 && rondas>0) {
			...
			atributoj1 = cartaj1.usarPocion(atributoj1);
			acontecimientos+=cartaj1.toStringPocion();
			if (cartaj1.toStringPocion()!="")
				acontecimientos+=atributoj1.getValorAtributo();
			acontecimientos+= ".\n"+jugador2.toString();
			...
			atributoj2 = cartaj2.usarPocion(atributoj2);
			acontecimientos+=cartaj2.toStringPocion();
			if (cartaj2.toStringPocion()!="")
				acontecimientos+=atributoj2.getValorAtributo();
		...
		if (jugador1.cantCartas()>jugador2.cantCartas()) {
			System.out.println("GANO "+jugador1.getNombre().toUpperCase());
		}else if (jugador1.cantCartas()<jugador2.cantCartas()) {
			System.out.println("GANO "+jugador2.getNombre().toUpperCase());
		}else {
			System.out.println(jugador1.getNombre().toUpperCase()+" Y "+jugador1.getNombre().toUpperCase()+" HAN EMPATADO");
		}
	}
}
